...
class ProductionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create production" do
    assert_difference('Production.count') do
      post productions_url, params: { production: { name: @production.name, price: @production.price } }
    end
  ...
  test "should update production" do
    patch production_url(@production), params: { production: { name: @production.name, price: @production.price } }
